...
- And please run the deployment in the `/deployment` directory. Instructions are in the Deployment section of this document. If you don't have the time you can take look at the installation en demo of the app: [https://youtu.be/hlz_RryCHV4](https://youtu.be/hlz_RryCHV4)
